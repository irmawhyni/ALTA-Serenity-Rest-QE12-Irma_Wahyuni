Feature: ALTA QE BATCH 12
  ...
  Scenario Outline: Get list user with valid parameter page
    ...
    Scenario: Post create a new user with valid json
      ...
      And Response body name was "Irma Wahyuni" and job was "QE Engineer"
    ...
    Scenario Outline: Put update user with valid json and user id
      ...
      Examples:
        ...
        | 1  | UpdateUser.json  | Irma Wahyuni   | QE Engineer   |
        | 2  | UpdateUser2.json | Irma Wahyuni 2 | QE Engineer 2 |
        | 3  | UpdateUser3.json | Irma Wahyuni 3 | QE Engineer 3       |
